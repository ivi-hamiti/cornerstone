    ...
    function disable(element) {
        ...
        for(var i=0; i < enabledElements.length; i++) {
            if(enabledElements[i].element === element) {
                ...
                cornerstone.trigger(element, "CornerstoneElementDisabled", eventData);
...
(function (cornerstone) {
    ...
    function displayImage(element, image, viewport) {
        ...
        cornerstone.trigger(enabledElement.element, "CornerstoneNewImage", newImageEventData);
...
(function (cornerstone) {
    ...
    function purgeCacheIfNecessary() {
        ...
        while(cacheSizeInBytes > maximumSizeInBytes) {
            ...
            cachedImages.pop();
            cornerstone.trigger(cornerstone, 'CornerstoneImageCachePromiseRemoved', {imageId: lastCachedImage.imageId});
        }

        var cacheInfo = cornerstone.imageCache.getCacheInfo();
        cornerstone.trigger(cornerstone, 'CornerstoneImageCacheFull', cacheInfo);
    }
...
(function (cornerstone) {
    ...
    function loadImageFromImageLoader(imageId) {
        ...
        imagePromise.then(function(image) {
            cornerstone.trigger(cornerstone, 'CornerstoneImageLoaded', {image: image});
        });
...
(function (cornerstone) {
    ...
    function drawImage(enabledElement, invalidated) {
        ...
        cornerstone.trigger(enabledElement.element, "CornerstoneImageRendered", eventData);
